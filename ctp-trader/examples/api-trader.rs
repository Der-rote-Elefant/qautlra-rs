...
const TRADER_FRONT: &'static str = "tcp://120.136.160.67:33437";
const BROKER_ID: &'static str = "9060";
const APPID: &'static str = "SHINNY_Q7V2_2.93";
const AUTH_CODE: &'static str = "UMYUGJRNAOTB96PZ";
struct Spi;
...
fn new_input_order(user_id: &str) -> CThostFtdcInputOrderField {
    ...
    set_cstr_from_str_truncate(&mut f.BrokerID, BROKER_ID);
    set_cstr_from_str_truncate(&mut f.InvestorID, user_id);
    set_cstr_from_str_truncate(&mut f.InstrumentID, "IF2206");
    set_cstr_from_str_truncate(&mut f.UserID, user_id);
