...
#[allow(dead_code)]
#[link(name = "sina_thostmduserapi_se")]
extern "C" {
    #[link_name = "_ZN15CThostFtdcMdApi15CreateFtdcMdApiEPKcbb"]
    fn CThostFtdcMdApiCreateFtdcMdApi(
        pszFlowPath: *const c_char,
        bIsUsingUdp: c_bool,
        bIsMulticast: c_bool,
    ) -> *mut c_void;
    ...
    fn CFtdcMdApiImplRegisterFensUserInfo(
        api: *mut c_void,
    ...
    fn CFtdcMdApiImplReqUserLogout(
        api: *mut c_void,
...
impl GenericMdApi for MdApi {
    fn new(flow_path: CString, use_udp: bool, use_multicast: bool) -> Self {
        ...
        let api = unsafe {
            CThostFtdcMdApiCreateFtdcMdApi(
                flow_path_ptr,
                use_udp as c_bool,
                use_multicast as c_bool,
            )
        };
    ...
    fn subscribe_market_data(&mut self, instrument_ids: &[CString]) -> ApiResult {
        ...
        from_api_return_to_api_result(unsafe {
            CFtdcMdApiImplSubscribeMarketData(self.md_api_ptr, v.as_ptr(), v.len() as c_int)
        })
    }
    ...
    fn unsubscribe_market_data(&mut self, instrument_ids: &[CString]) -> ApiResult {
        let v = cstring_slice_to_char_star_vec(instrument_ids);
        from_api_return_to_api_result(unsafe {
            CFtdcMdApiImplUnSubscribeMarketData(self.md_api_ptr, v.as_ptr(), v.len() as c_int)
        })
    }
    ...
    fn subscribe_for_quote_rsp(&mut self, instrument_ids: &[CString]) -> ApiResult {
        let v = cstring_slice_to_char_star_vec(instrument_ids);
        from_api_return_to_api_result(unsafe {
            CFtdcMdApiImplSubscribeForQuoteRsp(self.md_api_ptr, v.as_ptr(), v.len() as c_int)
        })
    }
    ...
    fn unsubscribe_for_quote_rsp(&mut self, instrument_ids: &[CString]) -> ApiResult {
        let v = cstring_slice_to_char_star_vec(instrument_ids);
        from_api_return_to_api_result(unsafe {
            CFtdcMdApiImplUnSubscribeForQuoteRsp(self.md_api_ptr, v.as_ptr(), v.len() as c_int)
        })
    }
    ...
    fn req_user_login(
        ...
        from_api_return_to_api_result(unsafe {
            CFtdcMdApiImplReqUserLogin(self.md_api_ptr, req_user_login, request_id)
        })
    }
    ...
    fn req_user_logout(
        ...
        from_api_return_to_api_result(unsafe {
            CFtdcMdApiImplReqUserLogout(self.md_api_ptr, req_user_logout, request_id)
        })
    }
}
...
impl<T> SenderMdSpi<T>
where
    T: From<MdSpiOutput> + Send + 'static,
{
...
impl<T> MdSpi for SenderMdSpi<T>
where
    T: From<MdSpiOutput> + Send + 'static,
{
    fn on_front_connected(&mut self) {
        self.sender
            .send(T::from(MdSpiOutput::FrontConnected(
                MdSpiOnFrontConnected {},
            )))
    ...
    fn on_front_disconnected(&mut self, reason: DisconnectionReason) {
        self.sender
            .send(T::from(MdSpiOutput::FrontDisconnected(
                MdSpiOnFrontDisconnected { reason },
            )))
    ...
    fn on_rsp_user_login(
        ...
        self.sender
            .send(T::from(MdSpiOutput::RspUserLogin(MdSpiOnRspUserLogin {
    ...
    fn on_rsp_user_logout(
        ...
        self.sender
            .send(T::from(MdSpiOutput::RspUserLogout(MdSpiOnRspUserLogout {
    ...
    fn on_rsp_error(&mut self, result: RspResult, request_id: i32, is_last: bool) {
        self.sender
            .send(T::from(MdSpiOutput::RspError(MdSpiOnRspError {
                result,
                request_id,
                is_last,
            })))
    ...
    fn on_rsp_sub_market_data(
        ...
        self.sender
            .send(T::from(MdSpiOutput::SubMarketData(
                MdSpiOnRspSubMarketData {
            ...
            .expect("spi callback send rsp_sub_market_data failed");
    }
    ...
    fn on_rsp_un_sub_market_data(
        ...
        self.sender
            .send(T::from(MdSpiOutput::UnSubMarketData(
                MdSpiOnRspUnSubMarketData {
                    specific_instrument: specific_instrument.cloned(),
                    result,
                    request_id,
                    is_last,
    ...
    fn on_rsp_sub_for_quote_rsp(
        ...
        self.sender
            .send(T::from(MdSpiOutput::SubForQuoteRsp(
            ...
            .expect("spi callback send rsp_sub_sub_for_quote_rsp failed");
    }
    ...
    fn on_rsp_un_sub_for_quote_rsp(
        ...
        self.sender
            .send(T::from(MdSpiOutput::UnSubForQuoteRsp(
                MdSpiOnRspUnSubForQuoteRsp {
                    specific_instrument: specific_instrument.cloned(),
                    result,
                    request_id,
                    is_last,
    ...
    fn on_rtn_depth_market_data(
        ...
        self.sender
            .send(T::from(MdSpiOutput::DepthMarketData(
                MdSpiOnRtnDepthMarketData {
                    depth_market_data: *depth_market_data.expect("depth_market_data is none"),
                },
            )))
            .expect("spi callback send depth_market_data failed");
    }

    fn on_rtn_for_quote_rsp(&mut self, for_quote_rsp: Option<&CThostFtdcForQuoteRspField>) {
        self.sender
            .send(T::from(MdSpiOutput::ForQuoteRsp(MdSpiOnRtnForQuoteRsp {
                for_quote_rsp: *for_quote_rsp.expect("for_quote_rsp is none"),
            })))
            .expect("spi callback send depth_market_data failed");
    }
}
...
extern "C" fn spi_on_rsp_user_login(
    ...
    unsafe {
        ...
        (*(*spi).md_spi_ptr).on_rsp_user_login(
...
extern "C" fn spi_on_rsp_user_logout(
    ...
    unsafe {
        let rsp_info = from_rsp_info_to_rsp_result(pRspInfo);
        (*(*spi).md_spi_ptr).on_rsp_user_logout(
            pUserLogout.as_ref(),
            rsp_info,
            nRequestID,
            bIsLast != 0,
...
#[allow(non_snake_case)]
extern "C" fn spi_on_rsp_sub_market_data(
    spi: *mut CThostFtdcMdSpi,
    ...
    unsafe {
        let rsp_info = from_rsp_info_to_rsp_result(pRspInfo);
        (*(*spi).md_spi_ptr).on_rsp_sub_market_data(
            pSpecificInstrument.as_ref(),
            rsp_info,
            nRequestID,
            bIsLast != 0,
        );
...
#[allow(non_snake_case)]
extern "C" fn spi_on_rsp_un_sub_market_data(
    spi: *mut CThostFtdcMdSpi,
    pSpecificInstrument: *const CThostFtdcSpecificInstrumentField,
    pRspInfo: *const CThostFtdcRspInfoField,
    nRequestID: c_int,
    ...
    unsafe {
        let rsp_info = from_rsp_info_to_rsp_result(pRspInfo);
        (*(*spi).md_spi_ptr).on_rsp_un_sub_market_data(
            pSpecificInstrument.as_ref(),
            rsp_info,
            nRequestID,
            bIsLast != 0,
...
#[allow(non_snake_case)]
extern "C" fn spi_on_rsp_sub_for_quote_rsp(
    spi: *mut CThostFtdcMdSpi,
    pSpecificInstrument: *const CThostFtdcSpecificInstrumentField,
    pRspInfo: *const CThostFtdcRspInfoField,
    nRequestID: c_int,
    ...
    unsafe {
        let rsp_info = from_rsp_info_to_rsp_result(pRspInfo);
        (*(*spi).md_spi_ptr).on_rsp_sub_for_quote_rsp(
            pSpecificInstrument.as_ref(),
            rsp_info,
            nRequestID,
            bIsLast != 0,
...
#[allow(non_snake_case)]
extern "C" fn spi_on_rsp_un_sub_for_quote_rsp(
    spi: *mut CThostFtdcMdSpi,
    pSpecificInstrument: *const CThostFtdcSpecificInstrumentField,
    pRspInfo: *const CThostFtdcRspInfoField,
    nRequestID: c_int,
    ...
    unsafe {
        let rsp_info = from_rsp_info_to_rsp_result(pRspInfo);
        (*(*spi).md_spi_ptr).on_rsp_un_sub_for_quote_rsp(
            pSpecificInstrument.as_ref(),
            rsp_info,
            nRequestID,
            bIsLast != 0,
...
#[allow(non_snake_case)]
extern "C" fn spi_on_rtn_depth_market_data(
    spi: *mut CThostFtdcMdSpi,
...
struct SpiVTable {
    ...
    #[allow(non_snake_case)]
    on_rsp_sub_market_data: extern "C" fn(
        spi: *mut CThostFtdcMdSpi,
        pSpecificInstrument: *const CThostFtdcSpecificInstrumentField,
        pRspInfo: *const CThostFtdcRspInfoField,
        nRequestID: c_int,
    ...
    #[allow(non_snake_case)]
    on_rsp_un_sub_market_data: extern "C" fn(
        spi: *mut CThostFtdcMdSpi,
        pSpecificInstrument: *const CThostFtdcSpecificInstrumentField,
        pRspInfo: *const CThostFtdcRspInfoField,
        nRequestID: c_int,
    ...
    #[allow(non_snake_case)]
    on_rsp_sub_for_quote_rsp: extern "C" fn(
        spi: *mut CThostFtdcMdSpi,
        pSpecificInstrument: *const CThostFtdcSpecificInstrumentField,
        pRspInfo: *const CThostFtdcRspInfoField,
        nRequestID: c_int,
    ...
    #[allow(non_snake_case)]
    on_rsp_un_sub_for_quote_rsp: extern "C" fn(
        spi: *mut CThostFtdcMdSpi,
        pSpecificInstrument: *const CThostFtdcSpecificInstrumentField,
        pRspInfo: *const CThostFtdcRspInfoField,
        nRequestID: c_int,
    ...
    #[allow(non_snake_case)]
    on_rtn_depth_market_data: extern "C" fn(
        spi: *mut CThostFtdcMdSpi,
        pDepthMarketData: *const CThostFtdcDepthMarketDataField,
    ),
    #[allow(non_snake_case)]
    on_rtn_for_quote_rsp:
        extern "C" fn(spi: *mut CThostFtdcMdSpi, pForQuoteRsp: *const CThostFtdcForQuoteRspField),
}
...
mod tests {
    ...
    fn spi_output_size() {
        ...
        assert_eq!(
            ...
            "MdSpiOutput expected size {}, actual size {}",
            expected_size, actual_size
        );
    }
